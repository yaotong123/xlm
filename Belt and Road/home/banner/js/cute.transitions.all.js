window.Transitions2D = {
	...
	tr41: {
		...
		effect: new Cute.Effect4({
			ease: TWEEN.Easing.Exponential,
			dir: 'horizontal',
			push: true
		})
	},
...
window.Transitions3D = {
	...
	tr64: {
		...
		col: 4,
		selector: new Aroma.RandSelector(),
		effect: new Cute.Effect12({
			ease: TWEEN.Easing.Back,
			zmove: -600,
			depth: 10,
			sidecolor: 0x777777
		})
